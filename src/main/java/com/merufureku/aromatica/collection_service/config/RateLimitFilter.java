...
public class RateLimitFilter extends OncePerRequestFilter {
    ...
    static {
        ...
        tempMap.put("/", new RateLimitConfig(30, Duration.ofMinutes(1), RateLimitScope.USER));
        tempMap.put("/{fragranceId}", new RateLimitConfig(30, Duration.ofMinutes(1), RateLimitScope.IP));
