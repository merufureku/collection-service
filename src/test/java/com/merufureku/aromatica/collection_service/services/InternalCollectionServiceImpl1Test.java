...
class InternalCollectionServiceImpl1Test {

    @InjectMocks
    private InternalCollectionServiceImpl1 internalCollectionServiceImpl1;
    ...
    public void testGetUserCollections_whenExists_thenReturnCollection() {
        ...
        BaseResponse<UserCollectionsResponse> response = internalCollectionServiceImpl1
    ...
    public void testGetUserCollections_whenUserNotExists_thenThrowException() {
        ...
        ServiceException exception = assertThrows(ServiceException.class,
                () -> internalCollectionServiceImpl1.getUserCollections(USER_ID, baseParam));
